 ...
 * @module fetcher
 * @description Modul ini berfungsi untuk mengambil data dari URL dengan berbagai format
 *
 * @license MIT
 * @copyright 2024
 *
...
const { toBuffer } = require("@seaavey/baileys");
    ...
    axios
      ...
      .then(async ({ data, headers }) => {
        ...
        let ext =
          ...
          (await fileType.fromBuffer(buffer)).ext ||
          "bin";
